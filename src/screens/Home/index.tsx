...
export function Home() {
  ...
  async function handleSignOut() {
    try {
      ...
      console.log(error)
      Alert.alert('Ocorreu um erro ao deslogar do app.')
    }
  }
  ...
  return (
    ...
    >
      <Header>
        ...
        <SignOutButton onPress={handleSignOut}>Sign Out
          {isLoggingOut ? <ActivityIndicator color="#fff" size={20} /> : <Feather name="power" size={24} color="#fff" />}
        </SignOutButton>
      </Header>
